...
<table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;">
    ...
    <tr><td style="background:#ffffff;border-radius:12px;border:1px solid #e4e4e7;padding:40px;">
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr><td style="font-size:22px;font-weight:700;color:#18181b;padding-bottom:8px;">Dear</td></tr>
            <tr><td style="font-size:15px;color:#52525b;line-height:1.7;padding-bottom:28px;">{!! nl2br($content) !!}</td></tr>
            <tr><td align="center">
                <a href="https://tw.getrapps.org" style="display:inline-block;background:#18181b;color:#ffffff;font-size:14px;font-weight:600;text-decoration:none;padding:12px 28px;border-radius:8px;">瀏覽官網</a>
            </td></tr>
        </table>
    </td></tr>
    <!-- Footer -->
